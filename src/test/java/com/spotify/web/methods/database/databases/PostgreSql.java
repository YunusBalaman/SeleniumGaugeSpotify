...
public class PostgreSql {
    ...
    public static Connection connectDatabase(String ip, String port, String databaseName, Properties properties){
       ...
       try{
           Class.forName(DatabaseEnum.POSTGRESQL.getDatabaseClassName());
           databaseConnection = DriverManager.getConnection(DatabaseEnum.POSTGRESQL.getJdbc() + ip + (port.isEmpty() ? "" : ":" + port)
