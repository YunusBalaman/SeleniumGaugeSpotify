...
public class JsMethods {
    ...
    public void openNewWindow(String url){
        ...
        String strWindowFeatures = "height=600,width=800,toolbar=1,Location=1,Directories=0,Status=0,menubar=1,Scrollbars=1,Resizable=1";
        String openNewTab = "window.open('" + url + "','_blank'," + strWindowFeatures + ");";
        jsDriver.executeScript(openNewTab);
    }
    ...
    public void clearLocalStorage(){
        ...
        assertEquals("0", jsDriver.executeScript("return localStorage.length;").toString());
    }
}
